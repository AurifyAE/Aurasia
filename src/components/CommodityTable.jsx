    ...
    <Box sx={{ width: "100%", overflow: "hidden" }}>
      <Box
        sx={{
          ...
          margin: ".4vw",
          background:
            "linear-gradient(180deg, rgba(20, 16, 12, 0.7) 0%, rgba(10, 8, 6, 0.6) 100%)",
          backdropFilter: "blur(0.35vw)",
          border: "0.1vw solid rgba(223, 186, 115, 0.4)",

          boxShadow: `
  inset 0 0 0.08vw rgba(255,255,255,0.15),
  0 0 0.8vw rgba(223, 186, 115, 0.12)
`,
        }}
      >
        <Typography
        ...
        {rows.length === 0 ? (
          ...
          <Swiper
            ...
            style={{
              ...
              margin: ".4vw",
              background:
                "linear-gradient(180deg, rgba(20, 16, 12, 0.5) 0%, rgba(10, 8, 6, 0.4) 100%)",
              backdropFilter: "blur(0.35vw)",
              border: "0.1vw solid rgba(223, 186, 115, 0.3)",

              boxShadow: `
  inset 0 0 0.08vw rgba(255,255,255,0.15),
  0 0 0.8vw rgba(223, 186, 115, 0.08)
`,
            }}
          >
            «
